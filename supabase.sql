...
begin
 ...
 insert into public.bids(item_number,bidder_name,amount,source,auth_user_id,bidder_email,bidder_address,bidder_age) values(p_item_number,v_name,p_amount,p_source,v_user_id,v_email,v_address,p_bidder_age);
 return jsonb_build_object('ok',true,'message','Bid accepted.');
end; $$;
